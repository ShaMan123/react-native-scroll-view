...
const dismissKeyboard = ReactNative.Keyboard.dismiss;
const flattenStyle = StyleSheet.flatten;
const invariant = (cond, ...args) => !cond && console.error(...args);//require('fbjs/lib/invariant');
...
if (Platform.OS === 'android') {
  ...
  AndroidContentView = requireNativeComponent(
    'AndroidZoomableContentView',
  );
...
render() {
  ...
  if (Platform.OS === 'android') {
    if (this.props.horizontal) {
      ...
      ScrollContentContainerViewClass = AndroidContentView;
    }
  } else {
    ScrollViewClass = RCTScrollView;
    ScrollContentContainerViewClass = RCTScrollContentView;
  }
    console.log('hello',ScrollContentContainerViewClass !== undefined)
    console.log('byre', ScrollViewClass !== undefined)
  invariant(

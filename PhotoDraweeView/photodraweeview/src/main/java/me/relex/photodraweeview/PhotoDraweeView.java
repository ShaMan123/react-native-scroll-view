...
public class PhotoDraweeView extends ReactImageView implements IAttacher {

    private Attacher mAttacher;

    private boolean mEnableDraweeMatrix = true;

    public PhotoDraweeView(Context context, AbstractDraweeControllerBuilder draweeControllerBuilder) {
        super(context, draweeControllerBuilder, null);
        init();
    }
/*
